...
fname = "/Users/satvikverma/Workspace/CSC-746/cp4/speedup-blocked.csv"
...
plt.title("Speedup Chart for Scaling Performance of BlockedMM")
...
plt.plot(code4_time, "c-s")
plt.plot(code5_time, "m-+")
plt.plot(code6_time, "y-*")
